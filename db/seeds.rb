...
# s1 = Station.create(name: "Liberty Av")
# s2 = Station.create(name: "Roosevelt Island")
# s3 = Station.create(name: "Bowling Green")
# s4 = Station.create(name: "Wall St")
# s5 = Station.create(name: "Central Av")
# s6 = Station.create(name: "Bedford Av")
# s7 = Station.create(name: "Grand St")
# s8 = Station.create(name: "DeKalb Av")
# s9 = Station.create(name: "Wilson Av")
# s10 = Station.create(name: "New Lots Av")
#
# t1 = TrainLine.create(name: "5" )
# t2 = TrainLine.create(name: "N" )
# t3 = TrainLine.create(name: "F" )
# t4 = TrainLine.create(name: "R" )
# t5 = TrainLine.create(name: "S" )
# t6 = TrainLine.create(name: "Q" )
# t7 = TrainLine.create(name: "1" )
# t8 = TrainLine.create(name: "4" )
# t9 = TrainLine.create(name: "2" )
# t10 = TrainLine.create(name: "3" )
#
# st1  = Stop.create(station: s1 , train_line: t1)
# st2  = Stop.create(station: s3 , train_line: t2)
# st3  = Stop.create(station: s3 , train_line: t3)
# st4  = Stop.create(station: s10 , train_line: t7)
# st5  = Stop.create(station: s5 , train_line: t4)
# st6  = Stop.create(station: s6 , train_line: t3)
# st7  = Stop.create(station: s10 , train_line: t6)
# st8  = Stop.create(station: s8 , train_line: t6)
# st9  = Stop.create(station: s9 , train_line: t3)
# st10 = Stop.create(station: s10 , train_line: t2)


def populate_database(data)
  data.each do |hash|
    station_name = hash[:"Stop Name"]
    train_line_name = hash[:"Daytime Routes"]
    s = Station.find_or_create_by(name: station_name)
    t = TrainLine.find_or_create_by(name: train_line_name)
    Stop.create(station: s, train_line: t)

    #find every station
    # hash data(seed file) , iterate over array do , put placeholder in pipeline
    #     then iterate over each hash and pull out the value that equal the key name "Stop Name"
  end
end
...
#
#   #find every train line
#   hash data(seed file) , iterate over array(we have the array..so do we iterate?), do , put placeholder in pipeline
#       then iterate over each hash and pull out the value that equal the key name "Daytime Routes"
#
#   end
#
#   #find stop (join table)
#   if "Stop Name" && "Daytime Routes"
#     return value of "Station ID"
# "Station ID"
#



# def show_train_lines(station) #station
...
# end
#
# def get_train_lines #trainlines
